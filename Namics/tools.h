...
__global__ void unity(double*, int);
__global__ void cp (double*, double*, int);
__global__ void cp (double*, int*, int);
__global__ void yisaplusctimesb(double*, double*,double*,double,int);
...
void Zero(int*, int);
void Unity(double*,int);
void Cp(double *, double *, int);
void Cp(double *, int *, int);
void YisAplusCtimesB(double*, double*, double*, double,int);
