...
`int update_density(vector<Real>& J, int sign = 1.0)`     //Explicit scheme <br>

`int update_density(vector<Real>& J1, vector<Real>& J2)` //Implicit scheme <br>
