...
cout <<"compostion" << GetValue("composition") << endl; 
...
cout <<"npos" << npos << endl;
if (block) cout <<"block : true " << endl; else cout <<"block : false " << endl; 
cout << "r0" << r[0] << endl; 
cout << "r1" << r[1] << endl; 
cout << "r2" << r[2] << endl; 
cout << "r3" << r[3] << endl; 
...
int result=0;
for (int i=0; i<M; i++) if (R_mask>0) result++;
cout <<"result Rmask" << result << endl; 
						theta_range = theta;
